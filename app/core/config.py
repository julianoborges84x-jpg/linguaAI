...
class Settings(BaseModel):
    ...
    stripe_success_url: str = os.getenv("STRIPE_SUCCESS_URL", "http://localhost:5173/dashboard")
    stripe_cancel_url: str = os.getenv("STRIPE_CANCEL_URL", "http://localhost:5173/dashboard")
    stripe_payment_method_types: str = os.getenv("STRIPE_PAYMENT_METHOD_TYPES", "")
